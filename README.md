...
This JWT token may be used by clients to authenticate to the Identity service to to any other service that signs its JWT tokens using the same CredentialSecret string.
